...
public class MyWidgetService extends RemoteViewsService {
	...
	public static class MyWidgetFactory implements
			RemoteViewsService.RemoteViewsFactory {

		private Context mContext;

		private String[] mFoods = new String[] { "Apple", "Banana", "Pear",
				"Handset", "People", "Bar", "Wind", "Song", "Source code",
				"Screen", "Package", "Cup", "Computer" };
		...
		public RemoteViews getViewAt(int position) {
			...
			RemoteViews views = new RemoteViews(mContext.getPackageName(),
					R.layout.news_widget_item);
			views.setTextViewText(R.id.item_summary, mFoods[position]);
			return views;
		}
